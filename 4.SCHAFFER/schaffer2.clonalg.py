...
#        MaxIt = 300         #Número máximo de iterações 
        ...
        VarMin=-100      #Limite inferior da função
        VarMax= 100    #Limite superio da função------------------------------------------------------------
    ...
    np.savetxt("clonalg_Schaffer.csv", resultados, delimiter=",")
    ...
    plt.xlabel("Iteração")
    plt.ylabel("Custo")
    plt.title("Custo por Iteração - Função Schaffer #2: Clonalg")
