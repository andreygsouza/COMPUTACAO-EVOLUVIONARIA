...
%% Load datas
clonalg = load('clonalg_Schaffer.csv');
de = load('de_Schaffer.csv');
ga = load('ga_Schaffer.csv');
pso = load('pso_Schaffer.csv');
tlbo = load('tlbo_Schaffer.csv');
...
title('Média de desempenho das Funções para Função Schaffer #2')
xlabel('Geração')
ylabel('Melhor F(x)')
grid on
hold off
