...
#        MaxIt = 300         #Número máximo de iterações 
        ...
        VarMin=-32.768      #Limite inferior da função
        VarMax= 32.768    #Limite superio da função------------------------------------------------------------
    ...
    np.savetxt("clonalg_ackley.csv", resultados, delimiter=",")
    ...
    plt.xlabel("Iteração")
    plt.ylabel("Custo")
    plt.title("Custo por Iteração - Função Ackley: Clonalg")
