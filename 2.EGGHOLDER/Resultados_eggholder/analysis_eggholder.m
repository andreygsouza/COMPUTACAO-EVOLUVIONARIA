...
%% Load datas
clonalg = load('clonalg_eggholder.csv');
de = load('de_eggholder.csv');
ga = load('ga_eggholder.csv');
pso = load('pso_eggholder.csv');
tlbo = load('tlbo_eggholder.csv');
...
title('Média de desempenho das Funções para Função Eggholder')
xlabel('Geração')
ylabel('Melhor F(x)')
grid on
hold off
