...
def main():
    ...
    for rep in range(Nrep):
        ...
        VarMin = -512 #Limite inferior variáveis desconhecidas
        VarMax =  512 #Limite superior variáveis desconhecidas
    ...
    np.savetxt("de_eggholder.csv", resultados, delimiter=",")
    ...
    plt.xlabel("Iteração")
    plt.ylabel("Custo")
    plt.title("Custo por Iteração - Função Eggholder: Evolução Diferencial")
